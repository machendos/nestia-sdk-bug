                ...
                return __generator(this, function (_q) {
                    switch (_q.label) {
                        case 0:
                            ...
                            if (input !== undefined)
                                ...
                                ((_k = route.request) === null || _k === void 0 ? void 0 : _k.type) === "application/x-www-form-urlencoded"
                                    ...
                                    : ((_l = route.request) === null || _l === void 0 ? void 0 : _l.type) !== "text/plain"
                            ...
                            if (!((_m = connection.fetch) !== null && _m !== void 0)) return [3 /*break*/, 1];
                            _a = _m;
                            return [3 /*break*/, 3];
                        ...
                        case 6:
                            ...
                            return [3 /*break*/, 13];
                        case 7:
                            if (!(((_o = route.response) === null || _o === void 0 ? void 0 : _o.type) === "application/json")) return [3 /*break*/, 9];
                            return [4 /*yield*/, response.text()];
                        case 8:
                            text = _q.sent();
                            ...
                            return [3 /*break*/, 13];
                        case 9:
                            if (!(((_p = route.response) === null || _p === void 0 ? void 0 : _p.type) === "application/x-www-form-urlencoded")) return [3 /*break*/, 11];
                            _c = URLSearchParams.bind;
                            return [4 /*yield*/, response.text()];
                        case 10:
                            query = new (_c.apply(URLSearchParams, [void 0, _q.sent()]))();
                        ...
                        case 11:
                            ...
                            return [4 /*yield*/, response.text()];
                        case 12:
                            _d.data = _f.apply(_e, [_q.sent(), result.headers]);
                            _q.label = 13;
