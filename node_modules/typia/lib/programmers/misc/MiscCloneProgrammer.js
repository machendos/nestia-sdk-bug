...
(function (MiscCloneProgrammer) {
    MiscCloneProgrammer.write = function (project) { return function (modulo) {
            ...
            var config = {
                types: {
                    ...
                    output: function (type, name) {
                        return typescript_1.default.factory.createTypeReferenceNode("typia.Resolved<".concat(name !== null && name !== void 0 ? name : TypeFactory_1.TypeFactory.getFullName(project.checker)(type), ">"));
                    },
                },
                prefix: PREFIX,
                trace: false,
