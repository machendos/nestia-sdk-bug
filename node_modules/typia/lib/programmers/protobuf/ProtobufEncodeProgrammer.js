...
(function (ProtobufEncodeProgrammer) {
    ProtobufEncodeProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                ...
                var meta = ProtobufFactory_1.ProtobufFactory.metadata(modulo.getText())(project.checker, project.context)(collection)(type);
                ...
                var block = [
                    ...
                    callEncoder("writer")(typescript_1.default.factory.createNewExpression(importer.use("Writer"), undefined, [
                        typescript_1.default.factory.createIdentifier("sizer"),
                    ])),
    ...
    var decode_bool = function (index) { return function (input) {
        return typescript_1.default.factory.createBlock(__spreadArray(__spreadArray([], __read((index !== null ? [decode_tag(0)(index)] : [])), false), [
