...
var MetadataObject = (function () {
    ...
    MetadataObject.prototype._Is_literal = function () {
        var _this = this;
        var _a;
        return ((_a = this.literal_) !== null && _a !== void 0 ? _a : (this.literal_ = (function () {
            if (_this.recursive === true)
                return false;
            else if (_this.name === "__type")
                return true;
            else if (_this.name.startsWith("__type.o") === false)
                return false;
            var last = _this.name.substr("__type.o".length);
