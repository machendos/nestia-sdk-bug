...
(function (ImportAnalyzer) {
    ...
    function get_name(symbol) {
        var _a, _b;
        return explore_name(symbol.escapedName.toString(), (_b = (_a = symbol.getDeclarations()) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.parent);
    }
    /* ---------------------------------------------------------
    ...
    function explore_name(name, decl) {
        return decl && typescript_1.default.isModuleBlock(decl)
